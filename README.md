...
- makes it easy to provide a nice UX to your users, by restoring handy parts of the states after navigation actions
- makes it easy to share/restore application in current state
